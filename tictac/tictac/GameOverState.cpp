...
namespace Sonar
{
	GameOverState::GameOverState(GameDataRef data) : _data(data) //to bierze z _data
	{

	}

	void GameOverState::Init() //te rzeczy musz¹ byc spozycjonowane
	{
	...
	{
		sf::Event event;
		while (this->_data->window.pollEvent(event)) //dopoki polling na tym 
		{
			...
			if (this->_data->input.IsSpriteClicked(this->_retryButton, sf::Mouse::Left,
	...
	void GameOverState::Draw(float dt)
	{
		this->_data->window.clear(sf::Color::Red);
		 // to ma byc najpierw no bo tlo. te potem nie maja znaczenia
